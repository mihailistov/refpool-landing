    ...
    <section className="section gradient">
      <div className="mx-auto container-tight px-4 text-center">
        ...
        <p className="p max-w-2xl mx-auto">
          Connecting <b>ambitious brands</b> with <b>high-performing creators</b>. Launch campaigns that drive <b>real results</b>, 
          <b>reward</b> your best affiliates <b>instantly</b> with crypto payouts, and <b>scale what works — globally</b>.
        </p>
